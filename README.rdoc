...
{<img src="https://secure.travis-ci.org/bkuhlmann/db.png" />}[http://travis-ci.org/bkuhlmann/db]
...
Please log all feedback/issues via {GitHub Issues}[https://github.com/bkuhlmann/db/issues]. Thanks.
