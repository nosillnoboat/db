...
Should you encounter a _fe_sendauth no password supplied_ PostgreSQL error, double check you have added your
login and password credentials to the ~/.pgpass file in order to resolve the issue.
