...
{<img src="https://badge.fury.io/rb/db.png" alt="Gem Version" />}[http://badge.fury.io/rb/db]
{<img src="https://codeclimate.com/github/bkuhlmann/db.png" alt="Code Climate GPA" />}[https://codeclimate.com/github/bkuhlmann/db]
{<img src="https://secure.travis-ci.org/bkuhlmann/db.png" alt="Travis CI Status" />}[http://travis-ci.org/bkuhlmann/db]
...
3. Run: db -M -g
4. Edit the "remigrate_generator" and reorder the migrations (if necessary, otherwise move to the next step).
5. Run: db -M -e
6. Run: db -M -c
