...
and tweak your migrations as you see fit. You'll want to perform all six steps each time you undergo remigration.
Should you get cold feet and decide remigration is not for you, run the following command:

  db -M -r

This will restore your migrations to their original state.
